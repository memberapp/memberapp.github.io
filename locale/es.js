dictionary.es=
{
    ...
    "VV0019": "*Usuarios de Memo. También pueden iniciar sesión con su clave (WIF comprimida: Comienza con 'L..' o 'K..').",
    ...
    "VV0048": "Advertencia: Los metadatos de tus mensajes privados serán públicos en la blockchain (son el emisor, receptor, tamaño y horario de tu mensaje). Además, si la clave privada del receptor se vuelve pública en el futuro, los mensajes del receptor se volverán públicos. Usar la blockchain para mensajería generalmente no se recomienda. Sin embargo, ya estás grande y esta facilidad está disponible para ti si deseas usarla. ",
    ...
    "VV0137": "Estás viendo la versión previa de desarrollo de Member. Puede que necesites teclear SHIFT + recargar para obtener los últimos cambios. Generalmente, se recomienda eso",
